...
/**
 * AssertJ {@linkplain org.assertj.core.api.Assert assertions} that can be
 * Japplied to an {@link ExchangeResult}.
 *
 * @author Rossen Stoyanchev
 * @since 7.0
 */
public class ExchangeTestResultAssert extends AbstractObjectAssert<ExchangeTestResultAssert, ExchangeTestResult> {
	...
	ExchangeTestResultAssert(ExchangeTestResult actual) {
		super(actual, ExchangeTestResultAssert.class);
	 ...
	 */
	public ExchangeTestResultAssert hasStatus(int status) {
	 ...
	 * @param status the expected HTTP status code
	 */
	public ExchangeTestResultAssert hasStatus(HttpStatus status) {
	 ...
	 */
	public ExchangeTestResultAssert hasStatusOk() {
	 ...
	 */
	public ExchangeTestResultAssert hasStatus1xxInformational() {
	 ...
	 */
	public ExchangeTestResultAssert hasStatus2xxSuccessful() {
	 ...
	 */
	public ExchangeTestResultAssert hasStatus3xxRedirection() {
	 ...
	 */
	public ExchangeTestResultAssert hasStatus4xxClientError() {
	 ...
	 */
	public ExchangeTestResultAssert hasStatus5xxServerError() {
		return hasStatusSeries(HttpStatus.Series.SERVER_ERROR);
	}

	private ExchangeTestResultAssert hasStatusSeries(HttpStatus.Series series) {
	 ...
	 */
	public ExchangeTestResultAssert containsHeader(String name) {
	 ...
	 */
	public ExchangeTestResultAssert doesNotContainHeader(String name) {
	 ...
	 */
	public ExchangeTestResultAssert hasHeader(String name, String value) {
	 ...
	 */
	public ExchangeTestResultAssert hasContentType(MediaType contentType) {
	 ...
	 * @param contentType the expected content type
	 */
	public ExchangeTestResultAssert hasContentType(String contentType) {
		contentType().isEqualTo(contentType);
		return this.myself;
	}
	 ...
	 */
	public ExchangeTestResultAssert hasContentTypeCompatibleWith(MediaType contentType) {
	 ...
	 * @param contentType the expected compatible content type
	 */
	public ExchangeTestResultAssert hasContentTypeCompatibleWith(String contentType) {
		contentType().isCompatibleWith(contentType);
		return this.myself;
	}
	 ...
	 */
	public ExchangeTestResultAssert hasBodyTextEqualTo(String bodyText) {
